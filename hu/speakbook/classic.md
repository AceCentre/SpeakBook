...
<p>Speakbook է ոչ վերբալ հաղորդակցության գործիք մարդկանց համար, ովքեր չեն կարող խոսել, դժվարանում օգտագործելով իրենց ձեռքերը կամ ձեռքերը, բայց ով պահպանում օգտագործումը նրանց աչքերով. Այս հրատարակությունը այն մարդկանց համար, ովքեր կարող են կարդալ եւ Հեգել: Համար տարբերակների համար ոչ ընթերցողների, օտարալեզու տարբերակների, եւ գրպանի խմբագրությամբ, այցի<b>acecent.re/speakbook</b></p>
<h2 class="fsize-6">Հրահանգներ օգտագործման համար:</h2>
<p>Սկսել, դուք պետք է. որ speakbook, սեւ, ոչ մշտական ​​գրատախտակի գրիչ, շոր քսում դուրս, եւ խոսում գործընկեր:</p>
<p>Դուք եւ ձեր խոսում գործընկերը նստել հակառակ միմյանց մոտ երեք ոտնաչափ բացի: Կախված Ձեր տեսողության, դուք կարող եք գտնել այն օգտակար է նվազեցնել կամ բարձրացնել այս հեռավորությունը: Բացել speakbook վերապատրաստման էջում ներսում հետեւի կափարիչը: Սա արդեն լրացված է օգնել ձեզ սովորել հիմնական տեխնիկան: Երբ դուք «փակցնելու տիրապետում է այն, դուք կարող եք գրել ձեր սեփական էջերը, օգտագործելով դատարկ նորերը նախատեսված: Fold գրքի ետ ինքն ու պահել այն մինչեւ միջեւ, ձեզ, այնպես որ դուք, այնպես էլ կանգնած է «վերապատրաստման էջը», եւ դուք կարող եք տեսնել, թե միմյանց աչքերը միջոցով փոս է մեջտեղում: Դուք հիմա նայում ընտրության էջի վրա որոշել, թե որ մեկն է շփվել: Երբ դուք «ես որոշեցի, որ դուք ցույց են տալիս, ձեր գործընկեր, որ դուք պատրաստ են սկսել
- սա կարող է լինել նայելով ձեր գործընկեր եւ blinking, կամ waggling ձեր աչքերը վեր ու վար, - ինչ կոստյումներ դուք: Ապա նայեք հաղորդագրություն եք ուզում, մի վայրկյան, կամ այնքան, որին հաջորդում է մեծ խորհրդանիշ, նույն փոքրիկ մեկը կողմից կողմում է հաղորդագրության մեջ: Ձեր գործընկերը, ապա հետեւում է ձեր աչքի շարժումները, օրինակ, նա կարող է տեսնել, որ դուք նայեց վերեւի ձախ կողմում խորհրդի որին հաջորդում են մեծ եռանկյունու, այնպես որ, նա գիտի, որ դուք պետք է ուզում ասել "բաժակ թեյ»: Նա այնուհետեւ ասում է, «բաժակ թեյ» բարձրաձայն, եւ դուք հաստատեք սա ակնթարթի, կամ ինչ-որ այլ նախապես պայմանավորվել ազդանշանի</p>
<p>Սա է հիմնական տեխնիկան օգտագործելու համար speakbook: Այժմ դուք պետք է սովորել, թե ինչպես պետք է օգտագործել այլ էջերը գրքում, քանի որ ճշմարիտ հանճարը speakbook կայանում է իր կարողությունը, որպեսզի ձեզ հեշտ մուտք դեպի հարյուրավոր արտահայտություններ ձեր սեփական ընտրությամբ, արտահայտություններ, որոնք դուք կարող եք փոխել ցանկացած ժամանակ, ինչպես նաեւ միայն խոնավ կտորի եւ գրչի մի հարվածով:</p>
:::
...
<p>Յուրաքանչյուր էջը speakbook ունի 14 կամ 15 դատարկ բաժիններից է, որը դուք կարող եք գրել ձեր սեփական տեքստը. Որպեսզի օգտվողը կարող է տեղափոխել միջեւ տարբեր էջերում, մենք ստեղծել ենք «տունը» էջը: Ավելացնել դիմաց գրքի, եւ նշվում է սեւ «ՀՈՄ» էջանիշը ծայրին էջի. Այն գաղափարը, այն է, որ դուք գրում 7 արտահայտությունների եք օգտագործել առավել այս էջում, քանի որ դա այն է, որ էջի դուք միշտ սկսել է: Բացի այդ, 8 դատարկ շերտերով եք գրել հղումներ դեպի մյուս 8 դատարկ երկակի էջերը: Դրանք պետք է լինեն մասերը ձեր կյանքում, որ պահանջում է ավելի խորը շարք արտահայտություններ, դրանք կարող են լինել ոլորտներ, ինչպես օրինակ bathtime, կամ պատրաստվում են մեքենայի մեջ: Ին ձախ օրինակ է հնարավոր դասավորությունը է «տուն», էջում: 8 բառեր համարձակ մեծատառերով են հղումներ դեպի երկակի էջանոց տարածում այլուր գրքում: Ինչ եք անում է, որ դուք կգտնեք մի դատարկ էջը եւ գրել, օրինակ, «BED» եզրին էջանիշը, ապա շերտերով եք գրել, որ 14 արտահայտությունների առավել համապատասխանում է Ձեր bedtime ռեժիմ. Ապա դուք կրկնել այս գործընթացը մյուս 7 հղումները, մինչեւ ձեր գիրքը լի. Եթե ​​Դուք սխալվել եք, կամ ցանկանում են փոխել մի արտահայտություն, ապա պարզապես սրբել այն մի խոնավ Կտորի եւ սկսել նորից:</p>
<p>Է օգտագործել speakbook, դուք նշեք ձեր գործընկեր, որ դուք ուզում եք շփվել: Ձեր գործընկերը բացում է speakbook է «տուն» էջում եւ դուք շփվել, օրինակ, «BED»: Ձեր գործընկեր, ապա ստացվում է, որ «bed" էջում, եւ դուք կարող եք, ապա հաղորդակցվել, «Ես ուզում եմ գնալ քնելու», - կամ ինչ. Յուրաքանչյուր էջը ունի «տուն» եւ «Spell» նախընտրական տպագրված այն: «Տունն» է, այնպես որ դուք կարող եք միշտ կարող եք ստանալ ետ դեպի «ՀՈՄ» էջում (դուք կարող եք ցանկանում է «գավաթը թեյ!" To take քնելու ձեզ հետ): The "Spell" էջ թույլ է տալիս Ձեզ է հանգեցնել առանձին բառեր եւ արտահայտություններ, որոնք don "տ հայտնվել այլուր գրքում: Այն աշխատում է նույն կերպ, ինչպես մյուս էջերում, մեկ տարբերությամբ. Այս էջում կան 6 գունավոր արգելափակում, յուրաքանչյուրը 6 գունավոր տառեր կամ թվեր վրա այն. Ամբողջ այբուբենը կա, գումարած համարները 1-9 (զրոյական օգտագործման է նամակում O): Նայում եք, որ նամակում, որը ցանկանում եք շփվել, մի վայրկյան կամ այնքան, որին հաջորդում է գունավոր բլոկի նույն գույնի որպես ձեր ընտրած նամակում. Ձեր գործընկեր հետեւում է ձեր աչքերը, տեսնում է, որ դուք պետք է նայեց, օրինակ, վերին ձախ բլոկը, որին հաջորդում է վերեւի աջ բլոկի (որը կանաչ), եւ գիտի, որ դուք ուզում եք "C". Ձեր գործընկերը, - ասում է «C» բարձրաձայն հաստատում է, եւ դուք շարժվել դեպի հաջորդ նամակում: Ձեր գործընկերը guesses մնացած մասը բառը, երբ հնարավոր է, պետք է արագացնել այդ գործընթացը մինչեւ.</p>
<p>Speakbook ունի տեղիք 119 արտահայտություններ ձեր ընտրությամբ. Եթե ​​սա բավարար չէ, կամ, եթե դուք պետք է ավելի քան 14 արտահայտությունների մեկ կոնկրետ հատվածի, ապա դուք կարող եք կրկնապատկել իր կարողությունները `գրելով երկու արտահայտությունների վրա յուրաքանչյուր տողում, մեկը սեւ գրիչով, մեկը կարմիր. Դուք ընտրում եք մի սեւ արտահայտությունը բնականոն հունով, մեկ ուրիշ կարմիրն առ blinking երբ դուք նայում մեծ խորհրդանիշ:</p>
:::
