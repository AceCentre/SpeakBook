...
text:
  ring_bind_edge: Coloque argolas nesta margem
  cut_out_this_part: Recorte pelo picotado.
  SPEAKBOOK: SPEAKBOOK
  classic: classic
  EDITION: EDIÇÃO
...
<h2 class="my-2"> Apontar para soletrar. </h2>
<p class = "my-2">
...
  Palavras usadas com frequência podem ser escritas nos espaços em branco.
  Ao apontar para a palavra <strong class = "bold"> „ INÍCIO"*</strong> indica ao seu parceiro que deseja comunicar com seus olhos usando o livro.
</p>
:::
::: slot training-page-description
<p class = "fsize-3">
Quanto aprender a técnica de base usando esta página de teste, poderá usar as páginas em branco para personalizar o seu livro.
</p>
:::
